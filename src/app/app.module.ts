...
const routes:Routes = [
  ...
  {
    path: 'adminM', loadChildren: () => import('./pages/admin/admin.module').then(m => m.AdminModule)
  },
  {
    path: 'homeM', loadChildren: () => import('./pages/home/home.module').then(m => m.HomeModule)
  }
];
